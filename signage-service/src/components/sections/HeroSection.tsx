      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-8 py-4 bg-[#C86E4A] hover:bg-[#B05B3A] text-white text-[18px] font-medium rounded-full shadow-lg shadow-[#0040a133] transition-all">
              {t('cta_primary')}
            </button>
            <button className="px-8 py-4 bg-transparent border border-[#C86E4A] text-[#C86E4A] hover:bg-[#F3E2D5] text-[18px] font-medium rounded-full transition-all">
              {t('cta_secondary')}
            </button>
          </div>

          {/* Simple trust badge or info could go here as seen in microcopy */}
        ...
        <div className="relative aspect-square md:aspect-auto md:h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl">
          <Image
            ...
            priority
          />
          {/* Optional Overlay/Glassmorphism element from design */}
