        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-6 ltr:text-left rtl:text-right">
              <h2 className="text-[40px] md:text-[52px] xl:text-[64px] font-extrabold text-white leading-[1.05] tracking-tight">
                {t('title')}
              </h2>
              <p className="text-[18px] md:text-[20px] text-white/70 max-w-xl leading-relaxed">
                {t('subtitle')}
              </p>
            </div>

            <div className="flex flex-col gap-6">
              <p className="text-[13px] font-bold text-white/40 uppercase tracking-[2px] ltr:text-left rtl:text-right">
                {t('connect_label')}
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  ...
                  className="flex items-center gap-5 px-7 py-5 bg-white/5 hover:bg-[#25D366]/10 border border-white/10 hover:border-[#25D366]/40 rounded-[24px] transition-all duration-300 group"
                >
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#25D366]/10 text-[#25D366] group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex flex-col ltr:text-left rtl:text-right">
                    <span className="text-[14px] text-white/40 font-medium leading-none mb-1.5 group-hover:text-white/60 transition-colors">WhatsApp</span>
                    <span className="text-[17px] text-white font-bold leading-none">{t('write_us')}</span>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-5 px-7 py-5 bg-white/5 hover:bg-[#0088cc]/10 border border-white/10 hover:border-[#0088cc]/40 rounded-[24px] transition-all duration-300 group"
                >
                  <div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#0088cc]/10 text-[#0088cc] group-hover:scale-110 transition-transform">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.479.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" />
                    </svg>
                  </div>
                  <div className="flex flex-col ltr:text-left rtl:text-right">
                    <span className="text-[14px] text-white/40 font-medium leading-none mb-1.5 group-hover:text-white/60 transition-colors">Telegram</span>
                    <span className="text-[17px] text-white font-bold leading-none">{t('write_us')}</span>
                  </div>
                </a>
              </div>
