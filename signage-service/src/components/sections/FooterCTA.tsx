              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  ...
                  <a
                    ...
                    className="w-full flex items-center justify-center py-3.5 md:py-4 bg-white/5 hover:bg-[#25D366]/10 border border-white/10 hover:border-[#25D366]/40 rounded-[20px] transition-all duration-300 group text-[#25D366]"
                  >
                    <svg className="w-5 h-5 md:w-6 md:h-6 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center py-3.5 md:py-4 bg-white/5 hover:bg-[#0088cc]/10 border border-white/10 hover:border-[#0088cc]/40 rounded-[20px] transition-all duration-300 group text-[#0088cc]"
                  >
                    <svg className="w-5 h-5 md:w-6 md:h-6 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
