    ...
    visuals: [
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/cafe-mit-beleuchtetem-markisenvolant-am-abend.png',
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/atelier-mit-dunkelblauer-markise-am-tag.png',
        alt: 'Visualisierung eines Ladenlokals mit dunkelblauer Markise und beschriftetem Volant bei Tag',
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/beleuchteter-markisenvolant-detail-am-abend-cropped.png',
        alt: 'Detailaufnahme eines beleuchteten Markisen-Volants mit leuchtender Beschriftung am Abend',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
    ],
  ...
  brand: {
    ...
    visuals: [
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/atelier-mit-dunkelblauer-markise-am-tag.png',
        alt: 'Визуализация ателье с тёмно-синей маркизой и надписью на волане в дневное время',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/beleuchteter-markisenvolant-detail-am-abend-cropped.png',
        alt: 'Детальный вид волана маркизы с подсветкой и светящейся надписью в вечернее время',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
    ],
  ...
  brand: {
    ...
    visuals: [
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/atelier-mit-dunkelblauer-markise-am-tag.png',
        alt: 'Visualization of a boutique with a dark blue awning and lettered valance in daylight',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/beleuchteter-markisenvolant-detail-am-abend-cropped.png',
        alt: 'Close-up of an illuminated awning valance with glowing lettering in the evening',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
    ],
  ...
  brand: {
    ...
    visuals: [
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/atelier-mit-dunkelblauer-markise-am-tag.png',
        alt: 'Wizualizacja atelier z ciemnoniebieską markizą i napisem na falbanie w świetle dnia',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/beleuchteter-markisenvolant-detail-am-abend-cropped.png',
        alt: 'Zbliżenie podświetlanej falbany markizy z jasno świecącym napisem wieczorem',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
    ],
  ...
  brand: {
    ...
    visuals: [
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/atelier-mit-dunkelblauer-markise-am-tag.png',
        alt: 'Gündüz koyu mavi tenteli ve üzerinde yazı bulunan tente eteğine sahip bir atölyenin görselleştirmesi',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/beleuchteter-markisenvolant-detail-am-abend-cropped.png',
        alt: 'Akşam saatlerinde ışıklı yazıya sahip aydınlatılmış tente eteğinin yakın planı',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
    ],
  ...
  brand: {
    ...
    visuals: [
      ...
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/atelier-mit-dunkelblauer-markise-am-tag.png',
        alt: 'تصور لأتيليه بماركيزة زرقاء داكنة وحافة تحمل كتابة في وضح النهار',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
      {
        ...
        image: '/images/leistungen/beleuchtete-markisenvolants/beleuchteter-markisenvolant-detail-am-abend-cropped.png',
        alt: 'لقطة تفصيلية لحافة مظلة مضاءة تحمل كتابة متوهجة في المساء',
        layout: 'lg:col-span-6',
        sizes: '(min-width: 1024px) 50vw, (min-width: 640px) 50vw, 100vw',
      },
    ],
