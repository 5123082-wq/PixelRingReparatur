...
const CONTENT: Record<Locale, SolutionsContent> = {
  de: {
    ...
    problems: [
      ...
      },
      {
        ...
        solution: 'Bei Gefahr Strom abschalten, Abstand halten und direkt Kontakt aufnehmen. Keine Selbstreparatur versuchen.',
      },
    ],
  ...
  en: {
    ...
    problems: [
      ...
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Urgent repair required', symptom: 'Burning smell, sparks, loose parts, exposed cables or risk to pedestrians.', solution: 'If there is danger, switch off the power, keep distance, and contact us directly. Do not attempt self-repair.' },
    ],
    ...
    urgentPoints: ['If there is danger, switch off the power and keep distance.', 'Do not open electrical parts or loosen mounting yourself.', 'Photos help, but safety comes first.'],
  ...
  ru: {
    ...
    problems: [
      ...
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Нужен срочный ремонт', symptom: 'Запах гари, искры, болтающиеся части, открытые провода или риск для прохожих.', solution: 'При опасности отключите питание, держитесь на расстоянии и свяжитесь с нами напрямую. Не пытайтесь ремонтировать самостоятельно.' },
    ],
    ...
    urgentPoints: ['При опасности отключите питание и держитесь на расстоянии.', 'Не вскрывайте электрику и не снимайте крепления самостоятельно.', 'Фото помогают, но безопасность важнее.'],
  ...
  tr: {
    ...
    problems: [
      ...
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Acil onarim gerekli', symptom: 'Yanik kokusu, kivilcim, gevsek parca, acik kablo veya yayalar icin risk.', solution: 'Tehlike varsa elektriği kapatın, mesafe bırakın ve doğrudan iletişime geçin. Kendi kendinize onarmaya çalışmayın.' },
    ],
    ...
    urgentPoints: ['Tehlike varsa elektriği kapatın ve mesafe bırakın.', 'Elektrik parçaları açmayın veya montajı kendiniz gevşetmeyin.', 'Fotoğraf yardımcı olur, fakat güvenlik önce gelir.'],
  ...
  pl: {
    ...
    problems: [
      ...
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Potrzebna pilna naprawa', symptom: 'Zapach spalenizny, iskry, luźne części, odkryte przewody lub ryzyko dla pieszych.', solution: 'W razie zagrożenia odłącz zasilanie, zachowaj odstęp i skontaktuj się bezpośrednio. Nie naprawiaj samodzielnie.' },
    ],
    ...
    urgentPoints: ['W razie zagrożenia odłącz zasilanie i zachowaj odstęp.', 'Nie otwieraj części elektrycznych i nie luzuj mocowań samodzielnie.', 'Zdjęcia pomagają, ale bezpieczeństwo jest ważniejsze.'],
  ...
  ar: {
    ...
    problems: [
      ...
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'إصلاح عاجل مطلوب', symptom: 'رائحة احتراق، شرر، أجزاء مفكوكة، أسلاك مكشوفة أو خطر على المارة.', solution: 'عند وجود خطر، افصل التيار وابتعد عن الموقع وتواصل مباشرة. لا تحاول الإصلاح بنفسك.' },
    ],
    ...
    urgentPoints: ['عند وجود خطر، افصل التيار وابتعد عن الموقع.', 'لا تفتح أجزاء كهربائية ولا تفك التثبيت بنفسك.', 'الصور تساعد، لكن السلامة أولا.'],
