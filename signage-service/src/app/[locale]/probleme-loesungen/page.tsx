...
const CONTENT: Record<Locale, SolutionsContent> = {
  de: {
    ...
    problems: [
      ...
      },
      {
        ...
        symptom: 'Nur ein Teil der Beschriftung oder ein Buchstabe ist ausgefallen.',
        solution: 'PixelRing grenzt lokale Ursachen ein: Modul, Anschluss, Verdrahtung oder Elementzustand.',
      },
      {
        id: 'rain-fail',
        intent: 'rain-failure',
        title: 'Werbeanlage schaltet nach Regen ab',
        symptom: 'Nach Regen oder Feuchtigkeit kommt es zu Ausfall, Flackern oder Abschaltung.',
        solution: 'Wir behandeln das als Hinweis auf Feuchtigkeit, Abdichtung, Korrosion oder elektrische Schutzabschaltung.',
      },
      {
        id: 'peeling-film',
        intent: 'peeling-film',
      ...
      },
      {
        ...
        solution: 'Wir klären, ob Auffrischung, Austausch oder eine neue Beschriftung sinnvoller ist.',
      },
      {
        id: 'loose-sign',
        intent: 'loose-sign',
        ...
        solution: 'Das ist ein Warnsignal. PixelRing klärt Befestigung, Unterkonstruktion und nächste Schritte.',
      },
      {
        id: 'urgent',
        ...
        solution: 'Wenn gefahrlos möglich, Anlage ausschalten und direkt Kontakt aufnehmen. Keine Selbstreparatur versuchen.',
      },
    ],
    ...
    impactBefore: 'Vorher',
    impactAfter: 'Nachher',
    impactNote: 'Beispielhafte Darstellung, keine Umsatz- oder Ergebnisgarantie.',
    metrics: [
    ...
    urgentPoints: [
      'Anlage nur ausschalten, wenn das gefahrlos möglich ist.',
  ...
  en: {
    ...
    problems: [
      ...
      { id: 'peeling-film', intent: 'peeling-film', title: 'Window film is peeling', symptom: 'Lettering or film lifts at the edges or no longer adheres cleanly.', solution: 'PixelRing checks substrate, ageing, adhesion and whether cleaning, partial replacement or new film is sensible.' },
      { id: 'faded-film', intent: 'faded-film', title: 'Film has faded', symptom: 'Colors look weak, uneven or no longer match the brand.', solution: 'We clarify whether refresh, replacement or a new branding setup makes more sense.' },
      { id: 'loose-sign', intent: 'loose-sign', title: 'Sign is loose', symptom: 'The sign, box or elements look loose, crooked or unsafe.', solution: 'This is a safety signal. PixelRing checks mounting, substructure and next steps.' },
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Urgent repair required', symptom: 'Burning smell, sparks, loose parts, exposed cables or risk to pedestrians.', solution: 'If safe, switch off the system and contact us directly. Do not attempt self-repair.' },
    ],
    impactTitle: 'What can improve after the issue is fixed',
    impactIntro: 'These values are illustrative and show typical effects after visible defects are assessed and resolved.',
    impactBefore: 'Before',
    impactAfter: 'After',
    impactNote: 'Illustrative example, not a revenue or performance guarantee.',
    metrics: [
      { label: 'Visibility', before: 38, after: 86 },
      { label: 'Location impression', before: 44, after: 82 },
      { label: 'Customer orientation', before: 51, after: 79 },
      { label: 'Reduced outage risk', before: 32, after: 74 },
    ],
    urgentTitle: 'When is an urgent repair needed?',
    urgentText: 'Burning smell, sparks, loose parts, exposed wiring, storm damage or pedestrian risk should be reported directly.',
    urgentPoints: ['Switch off only if it is safe.', 'Do not open electrical parts or loosen mounting yourself.', 'Photos help, but safety comes first.'],
    urgentCta: 'Report urgent case',
    phoneCta: 'Call technician',
    assessmentTitle: 'What helps with the first assessment?',
    assessmentIntro: 'If you do not know the technical term, a photo and short description are enough to start.',
    assessmentPoints: ['photos of the affected area', 'what changed', 'address, city or region', 'whether it feels urgent', 'preferred contact method'],
  ...
  ru: {
    ...
    heroTrust: 'Одна заявка. Понятная оценка. Выполнение профильными специалистами.',
    primaryCta: 'Описать проблему',
    secondaryCta: 'Отправить фото',
    problemTitle: 'Какая ситуация похожа на вашу?',
    problemIntro: 'Начните с того, что видно. Такая классификация помогает быстрее обработать заявку.',
    ...
    problems: [
      ...
      { id: 'peeling-film', intent: 'peeling-film', title: 'Пленка на витрине отклеилась', symptom: 'Надпись или пленка отходит по краям и выглядит неаккуратно.', solution: 'PixelRing проверяет основание, старение, адгезию и выбирает чистку, частичную замену или новую оклейку.' },
      { id: 'faded-film', intent: 'faded-film', title: 'Пленка выгорела', symptom: 'Цвета стали бледными, неровными или не соответствуют бренду.', solution: 'Мы определяем, нужна ли локальная замена, обновление или новый брендированный слой.' },
      { id: 'loose-sign', intent: 'loose-sign', title: 'Вывеска шатается', symptom: 'Световой короб, щит или элементы выглядят нестабильно.', solution: 'Это сигнал безопасности. PixelRing проверяет крепления, основу и дальнейшие действия.' },
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Нужен срочный ремонт', symptom: 'Запах гари, искры, болтающиеся части, открытые провода или риск для прохожих.', solution: 'Если безопасно, отключите систему и свяжитесь с нами напрямую. Не пытайтесь ремонтировать самостоятельно.' },
    ],
    impactTitle: 'Что может улучшиться после устранения проблемы',
    impactIntro: 'Это не гарантия результата, а пример типичных эффектов после профессиональной оценки и ремонта.',
    impactBefore: 'До',
    impactAfter: 'После',
    impactNote: 'Иллюстративный пример, без гарантии роста продаж или показателей.',
    metrics: [
      { label: 'Видимость', before: 38, after: 86 },
      { label: 'Впечатление от точки', before: 44, after: 82 },
      { label: 'Ориентация клиентов', before: 51, after: 79 },
      { label: 'Снижение риска отказа', before: 32, after: 74 },
    ],
    urgentTitle: 'Когда ремонт считается срочным?',
    urgentText: 'Запах гари, искры, открытые провода, болтающиеся элементы, последствия шторма или риск для прохожих нужно сообщать напрямую.',
    urgentPoints: ['Отключайте систему только если это безопасно.', 'Не вскрывайте электрику и не снимайте крепления самостоятельно.', 'Фото помогают, но безопасность важнее.'],
    urgentCta: 'Сообщить срочно',
    phoneCta: 'Позвонить технику',
    assessmentTitle: 'Какие данные помогут для оценки?',
    assessmentIntro: 'Если вы не знаете технический термин, достаточно фото и короткого описания.',
    assessmentPoints: ['фото проблемного места', 'что изменилось', 'адрес, город или район', 'насколько это срочно', 'удобный способ связи'],
  ...
  tr: {
    metaTitle: 'Tabela Sorunlari? Tipik Hasarlar ve Cozumler | PixelRing',
    metaDescription:
      'Tabela, LED, isikli kutu, folyo ve vitrin markalama sorunlarini anlayin ve PixelRing talebi baslatin.',
    badge: 'Sorunlar ve Cozumler',
    heroTitle: 'Tabela sorunlarini tanimlayin ve dogru sonraki adimi secin',
    heroIntro:
      'Sorun elektrik, LED, folyo, montaj veya hava kosulu hasari mi emin degil misiniz? Gorunen sorunu anlatin veya fotograf gonderin. PixelRing mantikli sonraki adimi inceler.',
    heroTrust: 'Tek talep. Net degerlendirme. Uzman uygulama.',
    primaryCta: 'Sorunu anlat',
    secondaryCta: 'Foto gonder',
    problemTitle: 'Hangi durum sorununuzla eslesiyor?',
    problemIntro: 'Gordugunuz belirtiyle baslayin. Ilk siniflandirma talebin daha hizli ele alinmasina yardim eder.',
    problemCta: 'Talep gonder',
    problems: [
      { id: 'no-light', intent: 'sign-not-lighting', title: 'Tabela yanmiyor', symptom: 'Sistem karanlik kaliyor veya guvenilir sekilde calismiyor.', solution: 'PixelRing guc kaynagi, baglanti, nem, kontrol ve benzeri tipik nedenleri inceler.' },
      { id: 'flicker', intent: 'flickering-light', title: 'Tabela titriyor', symptom: 'Isik kararsiz, titriyor veya kisa sureli kesiliyor.', solution: 'LED modulleri, guc kaynaklari, kontrol uniteleri, temaslar veya nem olasiligi netlestirilir.' },
      { id: 'uneven-led', intent: 'uneven-led-light', title: 'LED isigi duzensiz', symptom: 'Bazi alanlar daha koyu, lekeli veya farkli parlaklikta.', solution: 'Moduller, hatlar, eskime ve uygun onarim ya da degisim adimlari kontrol edilir.' },
      { id: 'letter-out', intent: 'letter-not-lighting', title: 'Tek harf yanmiyor', symptom: 'Yazinin bir kismi veya tek bir harf arizali.', solution: 'PixelRing modul, baglanti, kablo veya eleman durumunu yerel olarak daraltir.' },
      { id: 'rain-fail', intent: 'rain-failure', title: 'Yagmurdan sonra kapaniyor', symptom: 'Yagmur veya nemden sonra ariza, titreme ya da kapanma oluyor.', solution: 'Bu nem, sizdirmazlik, korozyon veya elektrik koruma kapanmasi belirtisi olabilir.' },
      { id: 'peeling-film', intent: 'peeling-film', title: 'Vitrin folyosu kalkti', symptom: 'Yazi veya folyo kenarlardan kalkiyor ve temiz durmuyor.', solution: 'Zemin, eskime, yapisma ve temizlik, kismi degisim veya yeni folyo ihtiyaci incelenir.' },
      { id: 'faded-film', intent: 'faded-film', title: 'Folyo soldu', symptom: 'Renkler zayif, duzensiz veya markaya uygun degil.', solution: 'Yenileme, degisim veya yeni markalama katmani daha mantikli mi netlestirilir.' },
      { id: 'loose-sign', intent: 'loose-sign', title: 'Tabela sallaniyor', symptom: 'Tabela, kutu veya elemanlar gevsek ya da guvensiz gorunuyor.', solution: 'Bu bir guvenlik isaretidir. PixelRing montaj, alt konstruksiyon ve sonraki adimlari inceler.' },
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Acil onarim gerekli', symptom: 'Yanik kokusu, kivilcim, gevsek parca, acik kablo veya yayalar icin risk.', solution: 'Guvenliyse sistemi kapatin ve dogrudan iletisime gecin. Kendi kendinize onarmaya calismayin.' },
    ],
    impactTitle: 'Sorun giderildikten sonra ne iyilesebilir',
    impactIntro: 'Bu degerler garanti degil, gorunen kusurlar degerlendirilip giderildiginde tipik etkileri gosterir.',
    impactBefore: 'Once',
    impactAfter: 'Sonra',
    impactNote: 'Ornek gosterimdir, ciro veya performans garantisi degildir.',
    metrics: [
      { label: 'Gorunurluk', before: 38, after: 86 },
      { label: 'Konum etkisi', before: 44, after: 82 },
      { label: 'Musteri yonlendirme', before: 51, after: 79 },
      { label: 'Ariza riski azalir', before: 32, after: 74 },
    ],
    urgentTitle: 'Ne zaman acil onarim gerekir?',
    urgentText: 'Yanik kokusu, kivilcim, acik kablo, gevsek parca, firtina hasari veya yayalar icin risk dogrudan bildirilmelidir.',
    urgentPoints: ['Sadece guvenliyse sistemi kapatin.', 'Elektrik parcalari acmayin veya montaji kendiniz gevsetmeyin.', 'Fotograf yardim eder, fakat guvenlik once gelir.'],
    urgentCta: 'Acil durumu bildir',
    phoneCta: 'Teknisyeni ara',
    assessmentTitle: 'Ilk degerlendirme icin ne yardimci olur?',
    assessmentIntro: 'Teknik terimi bilmiyorsaniz fotograf ve kisa aciklama baslamak icin yeterlidir.',
    assessmentPoints: ['sorunlu alan fotograflari', 'ne degisti', 'adres, sehir veya bolge', 'aciliyet', 'iletisim yolu'],
    seoTitle: 'Tabela hasarlarini dogru siniflandirma',
    seoParagraphs: [
      'Isikli tabelalar, LED tabelalar ve isikli kutular guc kaynaklari, kontrol uniteleri, moduller, transformatorler, nem, korozyon veya eski baglantilar nedeniyle arizalanabilir.',
      'Kalkan folyo, solan yazi, hasarli harfler veya gevsek parcalar gibi gorunen markalama sorunlari konum algisini etkiler. Ilk fotograf degerlendirmesi kapsam belirlemeye yardim eder.',
  ...
  pl: {
    metaTitle: 'Problemy z reklamą? Typowe uszkodzenia i rozwiązania | PixelRing',
    metaDescription:
    ...
    secondaryCta: 'Wyślij zdjęcie',
    problemTitle: 'Która sytuacja pasuje do Twojego problemu?',
    problemIntro: 'Zacznij od tego, co widać. Pierwsza klasyfikacja pomaga szybciej obsłużyć zgłoszenie.',
    problemCta: 'Wyślij zgłoszenie',
    problems: [
      { id: 'no-light', intent: 'sign-not-lighting', title: 'Reklama nie świeci', symptom: 'Instalacja pozostaje ciemna albo uruchamia się niestabilnie.', solution: 'PixelRing sprawdza typowe przyczyny: zasilanie, moduł, połączenia, wilgoć i sterowanie.' },
      { id: 'flicker', intent: 'flickering-light', title: 'Reklama miga', symptom: 'Światło jest niestabilne, miga albo chwilowo zanika.', solution: 'Wyjaśniamy, czy rolę grają moduły LED, zasilacze, kontrolery, styki albo wilgoć.' },
      { id: 'uneven-led', intent: 'uneven-led-light', title: 'LED świeci nierówno', symptom: 'Część obszarów jest ciemniejsza, plamista lub ma inną jasność.', solution: 'Sprawdzane są moduły, przewody, starzenie i sensowne kroki naprawy lub wymiany.' },
      { id: 'letter-out', intent: 'letter-not-lighting', title: 'Pojedyncza litera nie świeci', symptom: 'Nie działa tylko część napisu albo jedna litera.', solution: 'PixelRing zawęża lokalne przyczyny: moduł, połączenie, okablowanie lub stan elementu.' },
      { id: 'rain-fail', intent: 'rain-failure', title: 'Reklama wyłącza się po deszczu', symptom: 'Po deszczu lub wilgoci pojawiają się awarie, miganie lub wyłączenia.', solution: 'Może to wskazywać na wilgoć, uszczelnienie, korozję lub zabezpieczenie elektryczne.' },
      { id: 'peeling-film', intent: 'peeling-film', title: 'Folia na witrynie odkleja się', symptom: 'Napis lub folia odchodzi na krawędziach i wygląda nieestetycznie.', solution: 'Sprawdzamy podłoże, starzenie, przyczepność i czy lepsze jest czyszczenie, częściowa wymiana czy nowa folia.' },
      { id: 'faded-film', intent: 'faded-film', title: 'Folia wyblakła', symptom: 'Kolory są słabe, nierówne albo nie pasują już do marki.', solution: 'Ustalamy, czy sens ma odświeżenie, wymiana lub nowa warstwa brandingu.' },
      { id: 'loose-sign', intent: 'loose-sign', title: 'Reklama się rusza', symptom: 'Szyld, kaseton albo elementy wyglądają na luźne lub niebezpieczne.', solution: 'To sygnał bezpieczeństwa. PixelRing sprawdza mocowanie, podkonstrukcję i kolejne kroki.' },
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'Potrzebna pilna naprawa', symptom: 'Zapach spalenizny, iskry, luźne części, odkryte przewody lub ryzyko dla pieszych.', solution: 'Jeśli to bezpieczne, wyłącz instalację i skontaktuj się bezpośrednio. Nie naprawiaj samodzielnie.' },
    ],
    impactTitle: 'Co może się poprawić po usunięciu problemu',
    impactIntro: 'To nie gwarancja, lecz przykład typowych efektów po fachowej ocenie i usunięciu widocznych usterek.',
    impactBefore: 'Przed',
    impactAfter: 'Po',
    impactNote: 'Przykład ilustracyjny, bez gwarancji sprzedaży lub wyników.',
    metrics: [
      { label: 'Widoczność', before: 38, after: 86 },
      { label: 'Wrażenie miejsca', before: 44, after: 82 },
      { label: 'Orientacja klientów', before: 51, after: 79 },
      { label: 'Mniejsze ryzyko awarii', before: 32, after: 74 },
    ],
    urgentTitle: 'Kiedy naprawa jest pilna?',
    urgentText: 'Zapach spalenizny, iskry, luźne elementy, odsłonięte przewody, szkody po burzy lub ryzyko dla pieszych należy zgłosić bezpośrednio.',
    urgentPoints: ['Wyłącz instalację tylko wtedy, gdy jest to bezpieczne.', 'Nie otwieraj części elektrycznych i nie luzuj mocowań samodzielnie.', 'Zdjęcia pomagają, ale bezpieczeństwo jest ważniejsze.'],
    urgentCta: 'Zgłoś pilny przypadek',
    phoneCta: 'Zadzwoń do technika',
    assessmentTitle: 'Co pomaga w pierwszej ocenie?',
    assessmentIntro: 'Jeśli nie znasz terminu technicznego, wystarczy zdjęcie i krótki opis.',
    assessmentPoints: ['zdjęcia uszkodzonego miejsca', 'co się zmieniło', 'adres, miasto lub region', 'czy sprawa jest pilna', 'preferowany kontakt'],
  ...
  ar: {
    ...
    primaryCta: 'وصف المشكلة',
    secondaryCta: 'إرسال صورة',
    problemTitle: 'أي حالة تشبه مشكلتك؟',
    problemIntro: 'ابدأ بما تراه. هذا يساعد على توجيه الطلب بسرعة وبشكل أوضح.',
    problemCta: 'إرسال طلب',
    problems: [
      { id: 'no-light', intent: 'sign-not-lighting', title: 'اللوحة لا تضيء', symptom: 'اللوحة تبقى مظلمة أو تعمل بشكل غير مستقر.', solution: 'PixelRing يراجع أسبابا شائعة مثل التغذية، وحدة الطاقة، التوصيل، الرطوبة والتحكم.' },
      { id: 'flicker', intent: 'flickering-light', title: 'اللوحة تومض', symptom: 'الإضاءة غير مستقرة أو تنقطع لفترات قصيرة.', solution: 'نوضح هل السبب قد يكون وحدات LED أو مزودات الطاقة أو المتحكمات أو نقاط التلامس أو الرطوبة.' },
      { id: 'uneven-led', intent: 'uneven-led-light', title: 'إضاءة LED غير متساوية', symptom: 'بعض المناطق أغمق أو مختلفة بوضوح.', solution: 'يتم فحص الوحدات والتغذية والتقادم وخطوات الإصلاح أو الاستبدال المناسبة.' },
      { id: 'letter-out', intent: 'letter-not-lighting', title: 'حرف واحد لا يضيء', symptom: 'جزء من الكتابة أو حرف واحد فقط متوقف.', solution: 'PixelRing يحدد السبب المحلي مثل الوحدة أو التوصيل أو الأسلاك أو حالة العنصر.' },
      { id: 'rain-fail', intent: 'rain-failure', title: 'اللوحة تتوقف بعد المطر', symptom: 'بعد المطر أو الرطوبة تظهر أعطال أو وميض أو توقف.', solution: 'قد يشير ذلك إلى رطوبة أو عزل أو تآكل أو فصل حماية كهربائية.' },
      { id: 'peeling-film', intent: 'peeling-film', title: 'الفويل على الواجهة انفصل', symptom: 'الفويل أو الكتابة تنفصل من الحواف ولا تبدو نظيفة.', solution: 'نفحص السطح والتقادم والالتصاق وهل الأنسب تنظيف أو استبدال جزئي أو فويل جديد.' },
      { id: 'faded-film', intent: 'faded-film', title: 'الفويل باهت', symptom: 'الألوان ضعيفة أو غير متساوية أو لا تناسب العلامة.', solution: 'نوضح هل التحديث أو الاستبدال أو طبقة براندينغ جديدة هو الخيار الأنسب.' },
      { id: 'loose-sign', intent: 'loose-sign', title: 'اللوحة تتحرك', symptom: 'اللوحة أو الصندوق أو العناصر تبدو غير ثابتة أو غير آمنة.', solution: 'هذه إشارة سلامة. PixelRing يراجع التثبيت والبنية والخطوات التالية.' },
      { id: 'urgent', intent: 'urgent-safety-risk', title: 'إصلاح عاجل مطلوب', symptom: 'رائحة احتراق، شرر، أجزاء مفكوكة، أسلاك مكشوفة أو خطر على المارة.', solution: 'إذا كان آمنا، أوقف النظام وتواصل مباشرة. لا تحاول الإصلاح بنفسك.' },
    ],
    impactTitle: 'ما الذي قد يتحسن بعد حل المشكلة',
    impactIntro: 'هذه القيم توضيحية وليست ضمانا، وتعرض آثارا شائعة بعد تقييم العطل الظاهر ومعالجته.',
    impactBefore: 'قبل',
    impactAfter: 'بعد',
    impactNote: 'عرض توضيحي وليس ضمانا للمبيعات أو الأداء.',
    metrics: [
      { label: 'الوضوح البصري', before: 38, after: 86 },
      { label: 'انطباع الموقع', before: 44, after: 82 },
      { label: 'توجيه العملاء', before: 51, after: 79 },
      { label: 'تقليل خطر التعطل', before: 32, after: 74 },
    ],
    urgentTitle: 'متى يكون الإصلاح عاجلا؟',
    urgentText: 'رائحة الاحتراق، الشرر، الأجزاء المفكوكة، الأسلاك المكشوفة، أضرار العاصفة أو خطر المارة يجب الإبلاغ عنها مباشرة.',
    urgentPoints: ['أوقف النظام فقط إذا كان ذلك آمنا.', 'لا تفتح أجزاء كهربائية ولا تفك التثبيت بنفسك.', 'الصور تساعد، لكن السلامة أولا.'],
    urgentCta: 'الإبلاغ عن حالة عاجلة',
    phoneCta: 'الاتصال بالفني',
    assessmentTitle: 'ما المعلومات المفيدة للتقييم الأول؟',
    assessmentIntro: 'إذا كنت لا تعرف المصطلح الفني، تكفي صورة ووصف قصير للبدء.',
    assessmentPoints: ['صور للمنطقة المتأثرة', 'ما الذي تغير', 'العنوان أو المدينة أو المنطقة', 'هل الحالة عاجلة', 'طريقة التواصل المفضلة'],
    ...
    faqs: [
      ...
      { question: 'هل أفحص المشكلة الكهربائية بنفسي؟', answer: 'لا. أوقف النظام فقط إذا كان آمنا وأبلغ عن الحالة مباشرة.' },
    ],
