...
- Content Core (Block 2): complete; unified multi-locale editor with all 7 block types; field mapping for hero/cardList/cta audited and fixed. CMS Editor Stage 1 (Lists & Smart Sync): complete. CMS Content Scaling (Stage 2): complete — ExcellenceCarousel, RoadmapSection, BentoGridSection now iterate dynamically from CMS; IntakeSection already correct.
